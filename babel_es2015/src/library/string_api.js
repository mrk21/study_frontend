...
export default function stringApi() {
  console.group('String API');
  {
    ...
    console.group('ES-Next: Stage-2: String.prototype.{trimLeft,trimRight}');
    {
      console.log("'  hoge  '.trimLeft() =>", `'${'  hoge  '.trimLeft()}'`);
      console.log("'  hoge  '.trimRight() =>", `'${'  hoge  '.trimRight()}'`);
    }
    console.groupEnd();
  }
  console.groupEnd();
